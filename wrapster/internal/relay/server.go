...
import (
	...
	"github.com/trustroots/nostroots/vibe/wrapster/internal/auth"
...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if strings.HasPrefix(r.URL.Path, "/media/api/") {
		s.MediaGateway.ServeHTTP(w, r)
		return
	}
...
func (s *Server) health(w http.ResponseWriter, r *http.Request) {
	...
	if s.GenericProxy != nil {
		proxyStatus = s.GenericProxy.Status()
